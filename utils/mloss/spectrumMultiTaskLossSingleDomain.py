...
class spectrumMultiTaskLossSingleDomain(nn.Module):
    def __init__(self, dt, nb_outputs=2):
        super(spectrumMultiTaskLossSingleDomain, self).__init__()
        self.dt = dt
        self.nb_outputs = nb_outputs
        # learnable log variances for weighting each objective
        self.log_vars = nn.Parameter(torch.zeros(nb_outputs, 3))
